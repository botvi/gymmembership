                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Tambah Boxing dan Muaythai</h5>
                            </div>
                            <hr>
                            <form action="{{ route('listboxingmuaythai.store') }}" method="POST" class="row g-3">
                                @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea  rows="5" type="text" class="form-control" id="deskripsi" name="deskripsi" required></textarea>
                                </div>
