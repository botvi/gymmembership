...
<head>
	...
	<!--favicon-->
	<link rel="icon" href="https://st4.depositphotos.com/3265223/24936/v/450/depositphotos_249366040-stock-illustration-fitness-gym-logo-with-strong.jpg" type="image/png" />
	<!--plugins-->
	...
	<title>Login - No Limit GYM</title>
</head>
								...
								<div class="border p-4 rounded">
                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" action="{{ route('login') }}" method="POST">
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <a href="{{ route('register.form') }}" class="btn btn-primary"><i class="bx bxs-lock-close"></i>Sign Up</a>
                                                </div>
                                            </div>
