                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Tambah Membership Package</h5>
                            </div>
                            <hr>
                            <form action="{{ route('admin.package.store') }}" method="POST" class="row g-3">
                                @csrf
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="number" class="form-control" id="sesi" name="sesi" readonly>
                                </div>
