    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">BOXING MUAYTHAI</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">MEMBER BOXING MUAYTHAI</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <!--end breadcrumb-->
            <h6 class="mb-0 text-uppercase">MEMBER BOXING MUAYTHAI</h6>
            <hr />
            <div class="row mb-4">
                <div class="col-12">
                    <form action="{{ route('admin.manage_boxing_muaythai.index') }}" method="GET">
            ...
            <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-4">
                @foreach ($boxingMuaythai as $item)
                    <div class="col">
                                ...
                                <div class="p-4 border radius-15">
                                    ...
                                    <div class="d-grid">
                                        @if ($item->member_status == 'active')
                                            <a href="{{ route('admin.manage_boxing_muaythai.update_session_count', $item->id) }}" class="btn btn-outline-success radius-15">Hadir</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
