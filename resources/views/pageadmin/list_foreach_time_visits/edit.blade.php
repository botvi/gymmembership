                ...
                <div class="col-xl-7 mx-auto">
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            ...
                            <hr>
                            <form action="{{ route('listforeachtimevisit.update', $membership->id) }}" method="POST" class="row g-3">
                                @csrf
                                @method('PUT')
                                <div class="col-12">
                                    <label for="nama_list" class="form-label">Nama List</label>
                                    <input type="text" class="form-control" id="nama_list" name="nama_list" value="{{ $membership->nama_list }}" required>
                                </div>
                                <div class="col-12">
