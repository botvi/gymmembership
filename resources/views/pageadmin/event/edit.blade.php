                ...
                <div class="col-xl-7 mx-auto">
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            ...
                            <hr>
                            <form action="{{ route('events.update', $existingData->id) }}" method="POST"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama" readonly
                                        value="{{ $existingData->nama }}">
                                </div>

                                <div class="col-12">
                                    <label for="deskripsi" class="form-label">Deskripsi</label>
                                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3">{{ $existingData->deskripsi }}</textarea>
                                </div>

                                <div class="col-12">
                                    <label for="lokasi" class="form-label">Lokasi</label>
                                    <input type="text" class="form-control" id="lokasi" name="lokasi" readonly
                                        value="{{ $existingData->lokasi }}">
                                </div>
